...
<header class="navbar-light navbar-sticky header-static border-bottom navbar-dashboard">
	...
	<nav class="navbar navbar-expand-xl">
		<div class="container">
			<!-- Logo START -->
			<a class="navbar-brand me-3" href="<?= site_url('admin') ?>">
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<ul class="navbar-nav navbar-nav-scroll mx-auto">
					...
					<!-- Nav item 1 Demos -->
					<li class="nav-item"><a class="nav-link" href="<?= base_url() ?>index.php/admin"><i class="bi bi-house-door me-1"></i>Dashboard</a></li>

					<!-- Nav item 2 Post -->
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" id="postMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="bi bi-pencil me-1"></i>Transaksi</a>
						<ul class="dropdown-menu" aria-labelledby="postMenu">
							<!-- dropdown submenu -->
							<li> <a class="dropdown-item" href="<?= base_url() ?>index.php/admin-transaction-penjualan">Data Penjualan</a> </li>
							<li> <a class="dropdown-item" href="<?= base_url() ?>index.php/admin-transaction-invoice">Data Invoice</a> </li>
						</ul>
					</li>

					<!-- Nav item 3 Pages -->
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" id="pagesMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="bi bi-folder me-1"></i>Master Data</a>
						<ul class="dropdown-menu" aria-labelledby="pagesMenu">
							<li> <a class="dropdown-item" href="<?= base_url() ?>index.php/admin-product">Data Produk</a></li>
							<li> <a class="dropdown-item" href="<?= base_url() ?>index.php/admin-category">Kategori Produk</a></li>
							<li> <a class="dropdown-item" href="<?= base_url() ?>index.php/admin-customer">Data Customer</a></li>
							<li class="dropdown-divider"></li>
							<li> <a class="dropdown-item" href="<?= base_url() ?>index.php/admin-laporan-penjualan" target="_blank"> <i class="text-danger fa-fw bi bi-card-text me-2"></i>Laporan Data Penjualan</a></li>
							<li> <a class="dropdown-item" href="<?= base_url() ?>index.php/admin-laporan-product" target="_blank"> <i class="text-danger fa-fw bi bi-card-text me-2"></i>Laporan Data Produk</a></li>
							<li> <a class="dropdown-item" href="<?= base_url() ?>index.php/admin-laporan-pelanggan" target="_blank"> <i class="text-danger fa-fw bi bi-card-text me-2"></i>Laporan Data Pelanggan </a></li>
						</ul>
					</li>
				</ul>
			...
			<div class="nav flex-nowrap align-items-center">
				...
				<div class="nav-item ms-2 ms-md-3 dropdown">
					...
					<ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
						...
						<!-- Links -->
						<li><a class="dropdown-item" href="<?= base_url()?>index.php/edit-profile"><i class="bi bi-person fa-fw me-2"></i>Account Settings</a></li>
