					...
					<div class="col-sm-6 col-md-4 col-lg-3">
						<div class="card border p-3 h-100">
							<div class="position-relative">
								<!-- Image -->
								<a href="<?= base_url() ?>index.php/detail-product/<?php echo $bs->id ?>" class="position-relative z-index-9"><img class="card-img" src="<?= base_url() ?>assets/images/shop/<?php echo $bs->image; ?>" alt=""></a>
								<!-- Overlay -->
