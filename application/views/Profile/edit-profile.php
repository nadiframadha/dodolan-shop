                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <input required id="con-name" name="alamat" type="text" class="form-control" value="<?php echo $user->alamat; ?>">

                                        <label for="deskripsi" class="form-label">Deskripsi</label>
                                        <input required id="con-name" name="deskripsi" type="text" class="form-control" value="<?php echo $user->deskripsi; ?>">
